...
-- удалены. "document_type" дополнительно заблокирован от общего редактора
-- (is_usable=0, is_editable=0) - управляется только через set_document_type;
...
VALUES
    ...
    ('page_count', 'Число страниц', NULL, 'combobox', 0, 1, 1, 1, 5),
